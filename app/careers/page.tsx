      ...
      <main className="grow pt-20">
        ...
        >
          <p className="mb-4">
            ...
            We've built our reputation on 30+ years of excellence and are
            looking for individuals who share our commitment.
          </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                If you're passionate about technology and customer service,
