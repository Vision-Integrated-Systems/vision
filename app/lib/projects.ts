...
export const projects: Project[] = [
 {
  ...
  },
  {
    ...
    duration: "4 Months",
    challenge: "The project required a future-proof technology infrastructure to support a wide range of community activities, from educational workshops to public events. The challenge was to design and implement a structured cabling system that could accommodate current needs while allowing for easy expansion as the community center's offerings grow.",
    solution: "We installed a robust structured cabling system using Cat6A to ensure high-speed connectivity throughout the facility. The A/V systems were designed to support both small group meetings and larger events, with integrated sound reinforcement and video capabilities. Our team worked closely with the client to ensure that the technology seamlessly integrated with the center's architectural design.",
    gearList: ["Cat6A Structured Cabling", "Integrated A/V Systems", "Sound Reinforcement", "Video Capabilities"],
    stats: [
