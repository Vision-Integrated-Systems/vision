    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="relative bg-slate-950 py-32 lg:py-40 text-center text-white overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-30 pointer-events-none">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600 rounded-full blur-[120px] mix-blend-screen"></div>
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-600 rounded-full blur-[120px] mix-blend-screen"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-light">
            Master your systems with our curated collection of how-to videos and
            tutorials.
          </p>
        </div>
      </section>
